...
<section class="zam-schedule-page">
    ...
    <div class="admin-schedule-hero mb-4">
        ...
        <p class="admin-schedule-hero-text">
            Раздел доступен заместителю директора. Здесь можно редактировать расписание
            по классам, учебным неделям и дням.
        </p>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-4">
                    ...
                    <small class="schedule-help">
                        Можно выбрать любой день — сайт сам перенесёт дату на понедельник.
                    </small>
                </div>
                ...
                <div class="col-12">
                    <div class="admin-schedule-filter-actions">
                        ...
                        <a href="/zam/schedule" class="btn btn-secondary">
                            Сбросить
                        </a>
                    </div>
                </div>
    ...
    <div class="admin-schedule-editor mb-4" id="editor">
        ...
        <form method="POST" action="/zam/schedule/store">
            @csrf
...
<div id="deleteScheduleModal" class="admin-delete-modal" style="display: none;">
    <div class="admin-delete-modal-box">
        ...
        <div class="admin-delete-modal-actions">
            ...
            <form method="POST" action="/zam/schedule/delete-day" id="deleteScheduleForm">
                @csrf
