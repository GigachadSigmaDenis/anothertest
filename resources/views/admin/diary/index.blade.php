...
<section class="admin-diary-page">
    ...
    <div class="admin-diary-hero mb-4">
        ...
        <p class="admin-diary-hero-text">
            ...
            чтобы добавить задание, материалы и оценки ученикам.
        </p>
    </div>
    ...
    <div class="admin-diary-filter mb-4">
        <form method="GET" class="row g-3">
            ...
            <div class="col-12">
                ...
                <a href="/admin/diary" class="btn btn-secondary">Сбросить</a>
            </div>
        </form>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-7">
            <div class="admin-diary-editor" id="diaryEditor">
                ...
                <form method="POST" action="/admin/diary/store" enctype="multipart/form-data">
                    @csrf
...
<script>
    ...
    function selectDiaryLesson(lessonNumber, subject, assignment) {
